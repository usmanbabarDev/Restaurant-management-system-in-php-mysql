...
<!--/header-->
  ...
  <div class="container-fluid">
    <div class="parallax-juice"></div>
    <br><br>
    <br><br>
    <center>
      <h2 class="soupTitle"> Fresh Juices </h2>
    </center>
    <br><br>

    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Varies</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-100</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Aloe</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Beetroot.</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-150</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Cantaloupe</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Cranberry</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Green coconut	</h4>  
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
     </div>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Cucumber</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Dandelion</h4>  
      </div>
      <div class="col mycol">
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Grape</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-500</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Grapefruit</h4>  
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
     </div>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow"> Guava.</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-250</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Honeydew
        </h4>  
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-100</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Honeydew</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Lemons</h4>  
      </div>
      <div class="col mycol">
