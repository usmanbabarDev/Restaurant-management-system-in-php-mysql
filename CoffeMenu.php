...
<!--/header-->
  ...
  <div class="container-fluid">
    <div class="parallax-coffee"></div>
    <br><br>
    <br><br>
    <center>
      <h2 class="soupTitle">Coffee </h2>
    </center>
    <br><br>

    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Cappuccino</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-100</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Espresso</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Flat White.</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-150</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Macchiato</h4>
  ...
  <br><br><br>
  <div class="parallax-coffee1"></div>
  </div>
