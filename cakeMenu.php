...
<!--/header-->
  ...
  <div class="container-fluid">
    <div class="parallax-cake"></div>
    <br><br>
    <br><br>
    <center>
      <h2 class="soupTitle"> Special Cakes</h2>
    </center>
    <br><br>

    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Yellow Butter Cake</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-100</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Pound Cake</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Red Velvet Cake</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-150</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Carrot Cake..</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">Flourless Cake.</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-250</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">cocolate cake
        </h4>  
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-100</h4>
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">apples cake</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-200</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">mango cake.</h4>  
      </div>
      <div class="col mycol">
    ...
    <div class="row soupRow">
      <div class="col-4 mycol0">
        <h4 class="glow">fruit cake</h4>
      </div>
      <div class="col mycol">
        <h4 class="glow">RS-280</h4>
      </div>
      <div class="col-4 mycol0">
        <h4 class="glow">Special cake</h4>  
      </div>
      <div class="col mycol">
